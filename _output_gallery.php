...
function fpf_fetch_album_content($aid, $params)
{
    ...
    //Get optional params, or set to default
    if(!isset($params['cols']))     $params['cols']     = 4;
    if(!isset($params['max']))      $params['max']      = 99999999999;
    if(!isset($params['start']))    $params['start']    = 0;
    if(!isset($params['swapHead'])) $params['swapHead'] = false;
    if(!isset($params['hideHead'])) $params['hideHead'] = false;
    if(!isset($params['hideCaps'])) $params['hideCaps'] = false;
    if(!isset($params['noLB']))     $params['noLB']     = false;
    ...
    $retVal['content'] .= "<span class=\"fpfcredit\">Generated by <i>Facebook Photo Fetcher</i></span>\n";
